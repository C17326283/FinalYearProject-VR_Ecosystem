...
public class BoidSensoryScript : MonoBehaviour
{
    public BoidTaskManager taskManager;//Script to pass the sensed objects back to
    ...
    {
        if (taskManager == null)
            taskManager = this.transform.GetComponentInParent<BoidTaskManager>();
    }
